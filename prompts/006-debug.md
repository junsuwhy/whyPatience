...
## 
請讀取 @.specify/memory/constitution.md, @specs/001-game-rules-md/plan.md, @specs/001-game-rules-md/plan.md ，並根據 tasks.md 上面的任務清單，找到 @tasks 資料夾下當前的 TXXX_{task_name}.md 檔案
